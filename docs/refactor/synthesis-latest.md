...
**Falsifiable smoke recipe against `REDACTED-INTERNAL-IP:7825`:**
...
2. **Loki check** (`REDACTED-INTERNAL-IP:13101`): `{app="REDACTED-PROJECT"} |= "skipping viz research plan for page insertion"` — expect one line per run on both paths (confirms preview-only premise).
