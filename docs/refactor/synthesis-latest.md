...
1. `kubectl exec deploy/libwit-backend -n researcher -- printenv OPENMEMORY_HOST` (read-only, pre-authorized prod-host scope) reveals host shape — managed DNS vs `127.0.0.1`.
