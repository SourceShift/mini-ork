...
- `WizardLoader` — `src/components/REDACTED/onboarding/WizardLoader.tsx` — loads state + machine. [CONSENSUS: 1/3] [STATUS: shipped]
- `DashboardWizardSurface` — `src/components/REDACTED/onboarding/DashboardWizardSurface.tsx` — wizard host (build save payload at `:345`). [CONSENSUS: 2/3] [STATUS: shipped]
- `wizardMachine` — `src/components/REDACTED/onboarding/wizardMachine.ts` — XState. [CONSENSUS: 1/3] [STATUS: shipped]
- `wizardSteps` — `src/components/REDACTED/onboarding/wizardSteps.ts` — step registry. [CONSENSUS: 1/3] [STATUS: shipped]
- `StepLanding` — `src/components/REDACTED/onboarding/steps/StepLanding.tsx`. [CONSENSUS: 1/3] [STATUS: shipped]
- `StepIntent` (onboarding) — `src/components/REDACTED/onboarding/steps/StepIntent.tsx`. [CONSENSUS: 1/3] [STATUS: shipped]
- `StepClarify` — `src/components/REDACTED/onboarding/steps/StepClarify.tsx`. [CONSENSUS: 1/3] [STATUS: shipped]
- `StepSample` — `src/components/REDACTED/onboarding/steps/StepSample.tsx` — sample variant display. [CONSENSUS: 1/3] [STATUS: shipped]
- `StepSteer` — `src/components/REDACTED/onboarding/steps/StepSteer.tsx` — evidence-based steering. [CONSENSUS: 1/3] [STATUS: shipped]
- `StepProfile` — `src/components/REDACTED/onboarding/steps/StepProfile.tsx`. [CONSENSUS: 1/3] [STATUS: shipped]
- `StepPlan` (onboarding) — `src/components/REDACTED/onboarding/steps/StepPlan.tsx`. [CONSENSUS: 1/3] [STATUS: shipped]
- `StepFullBook` — `src/components/REDACTED/onboarding/steps/StepFullBook.tsx`. [CONSENSUS: 1/3] [STATUS: shipped]
- `StepRefreshConfirm` — `src/components/REDACTED/onboarding/steps/StepRefreshConfirm.tsx`. [CONSENSUS: 1/3] [STATUS: shipped]
- `SampleChapterVariantCard` — `src/components/REDACTED/onboarding/SampleChapterVariantCard.tsx`. [CONSENSUS: 1/3] [STATUS: shipped]
- `EvidenceMeter` — `src/components/REDACTED/onboarding/EvidenceMeter.tsx`. [CONSENSUS: 1/3] [STATUS: shipped]
- `IntentModeChip` — `src/components/REDACTED/onboarding/IntentModeChip.tsx`. [CONSENSUS: 1/3] [STATUS: shipped]
- `SteerSectionPopover` — `src/components/REDACTED/onboarding/SteerSectionPopover.tsx`. [CONSENSUS: 1/3] [STATUS: shipped]
- `WizardErrorModal` — `src/components/REDACTED/onboarding/WizardErrorModal.tsx`. [CONSENSUS: 1/3] [STATUS: shipped]
- `WizardTopBar` — `src/components/REDACTED/onboarding/WizardTopBar.tsx`. [CONSENSUS: 1/3] [STATUS: shipped]
- `WizardStepper` — `src/components/REDACTED/onboarding/WizardStepper.tsx`. [CONSENSUS: 1/3] [STATUS: shipped]
- `RegisterModal` — `src/components/REDACTED/onboarding/RegisterModal.tsx`. [CONSENSUS: 1/3] [STATUS: shipped]
- `VariantGenerationStep` + `VariantReviewStep` — `src/components/REDACTED/onboarding/`. [CONSENSUS: 1/3] [STATUS: shipped]
- `OnboardingSurvey` — `src/components/REDACTED/onboarding/OnboardingSurvey.tsx`. [CONSENSUS: 1/3] [STATUS: shipped]
- `SaveAndLandingStep` — `src/components/REDACTED/onboarding/SaveAndLandingStep.tsx`. [CONSENSUS: 1/3] [STATUS: shipped]
...
- `MarkdownChrome` — `src/components/REDACTED/reader/MarkdownChrome.tsx:1` — Markdown-book reader chrome (sidebar TOC, progress strip, settings, header). [CONSENSUS: 1/3] [STATUS: shipped]
- `PdfChrome` — `src/components/REDACTED/reader/PdfChrome.tsx:1` + `PdfSidebar.tsx`, `PdfPageThumbnail.tsx`, `PdfMarginSidebar.tsx`. Auto-route when document kind = pdf. [CONSENSUS: 1/3] [STATUS: shipped]
- `CompareMode` — `src/components/REDACTED/reader/CompareMode.tsx:1` (Markdown) + `PdfCompareMode.tsx:1` (PDF). [CONSENSUS: 1/3] [STATUS: shipped]
- `HighlighterToolbar` — `src/components/REDACTED/highlighter/HighlighterToolbar.tsx:1` (row 128 = unified `SelectionActionRowAdapter`). 7 canonical actions (visualize/explain/extend/arxiv/code/rewrite/prompt). Flags `FEATURE_HIGHLIGHTER_UNIFIED_DISPATCH` (server/.env:472), `FEATURE_HIGHLIGHTER_DISPATCH_CODE` (:473), `FEATURE_HIGHLIGHTER_DERIVATIVE_GEMINI` (:480). [CONSENSUS: 1/3] [STATUS: shipped]
- `ReaderChatRail` — `src/components/REDACTED/reader/ReaderChatRail.tsx:1` — in-reader Q&A. Ask flow wraps `withFeature({name:'reader-chat:ask'})` at `:333`, calls `send` at `:349`. Social-proof variant flag `VITE_FEATURE_READER_CHAT_SOCIAL_PROOF` (`:1012`). [CONSENSUS: 2/3] [STATUS: shipped]
- `ReaderFloatingChat` — `src/components/REDACTED/reader/ReaderFloatingChat.tsx:1` + `MobileReaderAskSelectionSheet.tsx`. Flag `FEATURE_MOBILE_CHAT_SHEET` (src/utils/featureFlags.ts:24). [CONSENSUS: 2/3] [STATUS: shipped]
- `ReaderTranslationOverlay` — `src/components/REDACTED/reader/ReaderTranslationOverlay.tsx:1` — paragraph inline translation. [CONSENSUS: 1/3] [STATUS: shipped]
- `ChapterZoomControl` + `ChapterZoomTreeRail` + `ChapterZoomSummaryList` — `src/components/REDACTED/reader/`. [CONSENSUS: 2/3] [STATUS: shipped]
- `VerifiedLearningCard` — `src/components/REDACTED/reader/VerifiedLearningCard.tsx:1` — FSRS-style retention badge. [CONSENSUS: 1/3] [STATUS: shipped]
- `ShareProofButton` — `src/components/REDACTED/reader/ShareProofButton.tsx:1`. [CONSENSUS: 1/3] [STATUS: shipped]
- `ReaderShell` — `src/components/REDACTED/reader/shell/ReaderShell.tsx`. [CONSENSUS: 1/3] [STATUS: shipped]
- `ReaderShellTopBar` — `src/components/REDACTED/reader/shell/ReaderShellTopBar.tsx`. [CONSENSUS: 1/3] [STATUS: shipped]
- `ReaderShellScrubber` — `src/components/REDACTED/reader/shell/ReaderShellScrubber.tsx`. [CONSENSUS: 1/3] [STATUS: shipped]
- `ReaderShellComposer` — `src/components/REDACTED/reader/shell/ReaderShellComposer.tsx`. [CONSENSUS: 1/3] [STATUS: shipped]
- `ReaderShellAskRail` — `src/components/REDACTED/reader/shell/ReaderShellAskRail.tsx`. [CONSENSUS: 1/3] [STATUS: shipped]
- `ReaderShellSummaryPanel` — `src/components/REDACTED/reader/shell/ReaderShellSummaryPanel.tsx`. [CONSENSUS: 1/3] [STATUS: shipped]
- `ReaderShellViewModePopover` — `src/components/REDACTED/reader/shell/ReaderShellViewModePopover.tsx`. [CONSENSUS: 1/3] [STATUS: shipped]
- `ReaderShellOverflowMenu` — `src/components/REDACTED/reader/shell/ReaderShellOverflowMenu.tsx`. [CONSENSUS: 1/3] [STATUS: shipped]
- `ReaderShellThumbGrid` — `src/components/REDACTED/reader/shell/ReaderShellThumbGrid.tsx`. [CONSENSUS: 1/3] [STATUS: shipped]
- `BookToc` — `src/components/REDACTED/reader/BookToc.tsx`. [CONSENSUS: 1/3] [STATUS: shipped]
- `ChapterZoomTreeRail` — see chapter-zoom group. [CONSENSUS: 1/3] [STATUS: shipped]
- `ReaderProgressStrip` — `src/components/REDACTED/reader/ReaderProgressStrip.tsx`. [CONSENSUS: 1/3] [STATUS: shipped]
- `TimeToMasteryCounter` — `src/components/REDACTED/reader/TimeToMasteryCounter.tsx`. [CONSENSUS: 1/3] [STATUS: shipped]
- `PdfMarginSidebar` — `src/components/REDACTED/reader/PdfMarginSidebar.tsx`. [CONSENSUS: 1/3] [STATUS: shipped]
- `MobileReaderCiteSheet` — `src/components/REDACTED/reader/MobileReaderCiteSheet.tsx`. [CONSENSUS: 1/3] [STATUS: shipped]
- `MobileReaderAskSelectionSheet` — `src/components/REDACTED/reader/MobileReaderAskSelectionSheet.tsx`. [CONSENSUS: 1/3] [STATUS: shipped]
- `MobileReaderHighlightsSheet` + `MobileReaderTOCSheet` + `MobileReaderFindSheet` — `src/components/REDACTED/reader/`. [CONSENSUS: 1/3] [STATUS: shipped]
