...
1. **BookReader page** (desktop + mobile)
   ...
   - Files: `src/pages/reader/BookReader.tsx`, `src/pages/reader/BookChapterArticle.tsx`,
     `src/components/REDACTED/reader/mobile/MobileReaderChrome.tsx`

2. **Highlighter toolbar** (selection-triggered, both viewports)
   - Files: `src/components/REDACTED/highlighter/HighlighterToolbar.tsx`,
     `src/components/REDACTED/reader/mobile/MobileReaderSelectionPopover.tsx`
