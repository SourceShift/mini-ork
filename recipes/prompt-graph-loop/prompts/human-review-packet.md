...
```json
{
  ...
  "feedback_delta": "required when decision is revise"
}
```

Do not decide on the human's behalf. The packet is a request for durable
operator input, not approval evidence.
