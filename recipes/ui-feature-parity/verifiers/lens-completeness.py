#!/usr/bin/env python3
# verifiers/lens-completeness.py — verify all 3 lens gap reports + synthesis
# exist, are non-empty, and cite at least one file:line anchor, and that the
# synthesis cross-references every lens.
#
# Inputs (via env):
...
# Synthesis must exist + cross-reference all 3 lenses
