...
this module delegates to ``mini_ork.ported.operator_steering.emit`` (the
...
Source paths this port tracks (kept in lockstep):
  ...
  py:   mini_ork/ported/operator_steering.py (peer)
"""
...
from mini_ork.ported.operator_steering import emit as ops_emit
