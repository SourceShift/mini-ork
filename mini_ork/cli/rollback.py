...
``mini_ork.registries.version_registry.rollback``.
...
``mini_ork.registries.version_registry.rollback``. Argument parsing, exit
...
def rollback(kind: str, name: str, db: str | None = None,
    ...
    Thin wrapper over :func:`mini_ork.registries.version_registry.rollback`.
